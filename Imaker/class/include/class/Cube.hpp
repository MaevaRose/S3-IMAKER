...
namespace Imaker{
  ...
  class Cube {
    public :
      ...
      void drawCube(glm::mat4 globalMVMatrix, GLint uMVPMatrixLoc, GLint uMVMatrixLoc, GLint uNormalMatrixLoc, float width, float length, float height); // afficher un cube avec TrackBallCamera
